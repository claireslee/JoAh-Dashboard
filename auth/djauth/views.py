...
def createTest(request):
    return render(request, 'djauth/addQuestion.html')
...
def studentAnnouncement(request):
    return render(request, 'studentDashboard/studentAnnouncement.html')

@login_required(login_url="/login")
def startExam(request):
    return render(request, 'studentDashboard/startExam.html')
...
def confirmation(request):
    return render(request, 'djauth/confirmation.html')
